...
>
	...
	<ol class="mb-4 list-inside list-decimal space-y-2">
		...
		<ul class="ml-4">
			<li class="list-disc">
				Letters in the cipher(Marked in green) have <strong class="text-emerald-500">three</strong> uses
			</li>
			<li class="list-disc">
				Vowels(Marked in orange) have <strong class="text-orange-500">two</strong> uses
			</li>
			<li class="list-disc">
				All other letters(Marked in greypn) have <strong class="text-gray-500">one</strong> use
			</li>
		</ul>
	</ol>
	...
	<ul class="mb-4 ml-4 list-inside list-disc">
		...
		<table class="my-4 table-fixed border-collapse border border-gray-300 text-left">
			<thead>
				<tr class="">
					<th class="w-1/2 border border-gray-300 px-3 py-1 text-sm">Mistakes + Replenishes</th>
